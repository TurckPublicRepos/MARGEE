...
| -------- | ---------------- | -------------------------- |
| **==**   | Equal            | ✅ results in int (0 or 1) |
| **\<>**  | Not equal        | ✅ results in int (0 or 1) |
| **\<=**  | Less or equal    | ✅ results in int (0 or 1) |
| **\<**   | Less             | ✅ results in int (0 or 1) |
| **>=**   | Greater or equal | ✅ results in int (0 or 1) |
| **>**    | Greater          | ✅ results in int (0 or 1) |
| **\***   | Multiply         | ✅ Yes                     |
| **/**    | Divide           | ✅ Yes                     |
| **%**    | Modulo           | ❌ No                      |
| **+**    | Add              | ✅ Yes                     |
